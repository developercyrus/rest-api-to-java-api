...
public class Product_detail_schema {
     ...
     * @param category
     */
    public Product_detail_schema(Category category, String create_time, Integer id, String modify_time, String name, Timezone timezone, Integer user_id) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Product_detail_schema) == false) {
            return false;
        }
        Product_detail_schema rhs = ((Product_detail_schema) other);
